...
const Hero = () => {
  ...
  return (
    ...
    w-full justify-center bg-cover bg-no-repeat min-h-screen"
    ...
    >
      ...
      >
        <button className="bg-primary text-white px-10 py-3 rounded-lg hover:scale-102 active:sacle-95 transition cursor-pointer">
          Start creating now
        </button>
